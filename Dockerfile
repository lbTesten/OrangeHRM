...
#ADD https://github.com/lbTesten/OrangeHRM/blob/master/orangehrm.zip ~/

# Download the source
RUN wget -c https://github.com/lbTesten/OrangeHRM/blob/master/orangehrm.zip -O ~/orangehrm.zip &&\
    unzip -o ~/orangehrm.zip -d /var/www/site && \
    rm ~/orangehrm.zip
